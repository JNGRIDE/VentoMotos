...
export const ProspectCard = memo(function ProspectCard({ prospect, userProfile, currentUserProfile, onDragStart, onMoveStage, onEdit, onDelete }: ProspectCardProps) {
  ...
  return (
    ...
    >
      <Card
        className={cn(
          "mb-1 shadow-soft hover:shadow-premium transition-all duration-300 group relative cursor-pointer border-none rounded-2xl overflow-hidden",
          borderColor,
        ...
        <CardContent className="p-4 pt-2 space-y-3">
           <div className="flex items-center justify-between">
              <div className="flex gap-1">
                  {phoneLink && (
                      <Button size="icon" variant="secondary" className="h-7 w-7 rounded-lg hover:bg-primary/10 hover:text-primary transition-all active:scale-90" asChild>
                  ...
                  {whatsappLink && (
                      <Button size="icon" variant="secondary" className="h-7 w-7 rounded-lg hover:bg-green-500/10 hover:text-green-600 transition-all active:scale-90" asChild>
